...
class SeeMoreWidget extends StatelessWidget {
   SeeMoreWidget({super.key, required this.movie , });
 final Movie movie;
  ...
  Widget build(BuildContext context,) {
    ...
    return GestureDetector(
      onTap: () {
         Provider.of<MovieProvider>(context, listen: false).setCurrentMovie(movie);
        Navigator.push(context, MaterialPageRoute(builder: (context) => DescripationScreen(movie: movie)));
      },
      child: Card(
